...
credentials for Resource Manager v1 project metadata/policies and project policies through the shared IAM gRPC mixin.
Anonymous/external credentials still bypass IAM; Pub/Sub, Secret Manager, GCS IAM, and other services remain unenforced.
