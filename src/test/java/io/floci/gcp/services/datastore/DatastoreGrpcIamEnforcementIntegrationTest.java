...
@QuarkusTest
@TestProfile(DatastoreGrpcIamEnforcementIntegrationTest.CtfIamProfile.class)
class DatastoreGrpcIamEnforcementIntegrationTest {
    ...
    void playerWithoutBindingIsDeniedLookup() {
        ...
        StatusRuntimeException ex = assertThrows(StatusRuntimeException.class,
                () -> stub.lookup(LookupRequest.newBuilder().setProjectId(PROJECT).build()));
    ...
    void rootTokenAlwaysCanLookup() {
        DatastoreGrpc.DatastoreBlockingStub stub = stubWithBearer(ROOT_TOKEN);
