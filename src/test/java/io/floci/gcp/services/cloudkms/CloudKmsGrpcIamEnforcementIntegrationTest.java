...
@QuarkusTest
@TestProfile(CloudKmsGrpcIamEnforcementIntegrationTest.CtfIamProfile.class)
class CloudKmsGrpcIamEnforcementIntegrationTest {
    ...
    @Test
    void playerWithCloudKmsAdminCanListKeyRings() {
        bindPlayer("roles/cloudkms.admin");
        KeyManagementServiceGrpc.KeyManagementServiceBlockingStub stub = stubWithBearer(PLAYER_TOKEN);

        ListKeyRingsResponse response = stub.listKeyRings(
    ...
    void rootTokenAlwaysCanListKeyRings() {
        KeyManagementServiceGrpc.KeyManagementServiceBlockingStub stub = stubWithBearer(ROOT_TOKEN);
