...
@QuarkusTest
@TestProfile(ServiceUsageIamEnforcementIntegrationTest.CtfIamProfile.class)
class ServiceUsageIamEnforcementIntegrationTest {

    private static final String PROJECT = "test-project";
    private static final String SERVICES = "/v1/projects/" + PROJECT + "/services";
    ...
    @Test
    void playerWithServiceUsageAdminCanListServices() {
        bindPlayer("roles/serviceusage.serviceUsageAdmin");
    ...
    @Test
    void playerWithConsumerCanListButNotEnable() {
        bindPlayer("roles/serviceusage.serviceUsageConsumer");
        ...
        given()
                ...
                .body("{}")
                .when().post(SERVICES + "/run.googleapis.com:enable")
                .then()
                .statusCode(403)
                .body("error.status", equalTo("PERMISSION_DENIED"));
    }
    ...
    @Test
    void playerWithServiceUsageAdminCanEnableService() {
        bindPlayer("roles/serviceusage.serviceUsageAdmin");
        ...
        given()
                ...
                .contentType("application/json")
                .body("{}")
                .when().post(SERVICES + "/pubsub.googleapis.com:enable")
                .then()
                .statusCode(200)
